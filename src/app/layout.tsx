...
export const metadata: Metadata = {
  ...
  title: 'AthletesMedicalFund UG | Medical Insurance for Ugandan Rugby Players',
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;700&family=Poppins:wght@700&family=Roboto:wght@400;700;900&display=swap" rel="stylesheet" />
      </head>
